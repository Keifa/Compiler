...
#line 1434 "binary.tab.cc" // lalr1.cc:859
  ...
  case 90:
#line 484 "binary.yy" // lalr1.cc:859
    {
      yylhs.value.as< Node > () = Node("parlist", "");
...
#line 1474 "binary.tab.cc" // lalr1.cc:859
  ...
  case 95:
#line 505 "binary.yy" // lalr1.cc:859
    {
...
#line 1482 "binary.tab.cc" // lalr1.cc:859
  ...
  case 96:
#line 508 "binary.yy" // lalr1.cc:859
    {
      yylhs.value.as< Node > () = Node("fieldlist", "");
      yylhs.value.as< Node > ().children.push_back(yystack_[1].value.as< Node > ());
...
#line 1500 "binary.tab.cc" // lalr1.cc:859
  ...
  case 98:
#line 516 "binary.yy" // lalr1.cc:859
    {
...
#line 1509 "binary.tab.cc" // lalr1.cc:859
  ...
  case 99:
#line 523 "binary.yy" // lalr1.cc:859
    {
...
#line 1518 "binary.tab.cc" // lalr1.cc:859
  ...
  case 100:
#line 527 "binary.yy" // lalr1.cc:859
    {
      yylhs.value.as< Node > () = Node("field", "");
      Node temp("name", "");
...
#line 1530 "binary.tab.cc" // lalr1.cc:859
  ...
  case 101:
#line 534 "binary.yy" // lalr1.cc:859
    {
      yylhs.value.as< Node > () = Node("field", "");
      yylhs.value.as< Node > ().children.push_back(yystack_[0].value.as< Node > ()); }
...
#line 1554 "binary.tab.cc" // lalr1.cc:859
  ...
  parser::yypact_[] =
  {
     ...
     273,   221,   -57,    58,   295,   -57,   -57,    72,    90,   217,
      14,   295,    60,   -57,   -57,    67,   -57,   -57,   -57,   114,
     253,   -57,   -57,    82,    55,    92,    35,    50,   -16,    70,
      -6,    95,   -57,   217,   -57,   -57,   -57,   126,   111,    -8,
     -57,    17,   -57,   139,   116,   117,   -57,   144,   132,   -57,
     -57,   -57,   -57,   221,     3,   -57,   221,    73,   160,   161,
     -57,   -57,   -57,   142,   143,   221,   -57,   -57,   207,    89,
      95,   273,   221,   221,   221,   221,   221,   221,   221,   221,
     221,   221,   221,   221,   221,   221,   253,   253,   253,   273,
     221,   221,   172,    10,   178,   179,   -57,   142,   221,   221,
     -57,   117,    94,   155,   -57,    18,    32,   -57,   -57,   221,
     159,   -57,    89,   -57,   -57,   -57,   184,    92,    35,    50,
      50,    50,    50,    50,    50,   -16,    70,    70,    -6,    -6,
      -6,    95,    95,   -57,    62,   162,     2,   -57,   273,   -57,
       9,   170,   -57,   -57,   -57,   -57,   -57,   -57,   -57,   -57,
     -57,   168,   -57,   -57,   -57,   221,   273,   109,   221,   273,
  ...
  parser::yypgoto_[] =
  {
     -57,   -57,   220,    -1,    12,   -57,    52,   -57,   -57,     0,
       5,   -47,    31,   -57,   148,   149,    71,   141,    41,    -3,
  ...
  parser::yytable_[] =
  {
     ...
     148,   -78,    58,    20,   171,   -78,   103,    97,   158,    50,
      ...
      77,    67,   105,    29,   112,    19,    62,    72,    84,   164,
      73,   141,   142,    62,   165,   166,     1,    23,    24,    82,
     126,    18,    19,    85,    86,    87,    88,    89,    81,    25,
     138,   139,   140,    26,    27,    28,    90,   113,   144,    18,
      19,    71,    11,   114,    29,    63,   120,    64,   150,    77,
      20,    93,    94,    30,    95,    83,   177,    74,    23,    24,
      31,   178,   179,   -32,   123,   -32,   124,   -33,    20,   -33,
      25,   145,   136,   137,    26,    27,    28,    99,    98,   155,
  ...
  parser::yycheck_[] =
  {
      ...
      29,    29,    45,    31,    64,    64,    14,     7,    33,     7,
       3,    96,    97,    21,    12,    13,     3,     4,     5,    24,
      81,    81,    81,    48,    49,    50,    51,    52,     6,    16,
      93,    94,    95,    20,    21,    22,    46,    66,    99,    99,
      99,   116,    29,    30,    31,    33,    75,    35,   103,    78,
      81,    41,    42,    40,    44,    23,     7,     3,     4,     5,
      47,    12,    13,    33,    35,    35,    37,    33,    99,    35,
      16,   100,    91,    92,    20,    21,    22,    11,    43,   108,
  ...
  parser::yyrline_[] =
  {
     ...
     272,   278,   291,   292,   300,   301,   309,   310,   315,   320,
     325,   330,   335,   343,   344,   352,   353,   358,   366,   367,
     372,   377,   385,   386,   391,   396,   403,   404,   412,   413,
     414,   415,   416,   420,   421,   422,   423,   427,   428,   429,
     433,   437,   447,   449,   452,   455,   461,   471,   474,   481,
     484,   487,   490,   497,   499,   505,   508,   513,   516,   523,
     527,   534,   540,   541
  };
