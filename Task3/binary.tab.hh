...
#line 125 "binary.tab.hh" // lalr1.cc:377
  ...
  basic_symbol (typename Base::kind_type t, const std::string v);
    ...
    static inline
    symbol_type
    make_PIPELINE (const std::string& v);

    static inline
    symbol_type
    make_WHITESPACE (const std::string& v);

    static inline
    symbol_type
    make_DOLLARSIGN (const std::string& v);

    static inline
    symbol_type
    make_SINGLEQUOTE (const std::string& v);

    static inline
    symbol_type
    make_DOUBLEQUOTE (const std::string& v);
  ...
  parser::symbol_type
  parser::make_PIPELINE (const std::string& v)
  {
    return symbol_type (token::PIPELINE, v);
  }

  parser::symbol_type
  parser::make_WHITESPACE (const std::string& v)
  {
    return symbol_type (token::WHITESPACE, v);
  }

  parser::symbol_type
  parser::make_DOLLARSIGN (const std::string& v)
  {
    return symbol_type (token::DOLLARSIGN, v);
  }

  parser::symbol_type
  parser::make_SINGLEQUOTE (const std::string& v)
  {
    return symbol_type (token::SINGLEQUOTE, v);
  }

  parser::symbol_type
  parser::make_DOUBLEQUOTE (const std::string& v)
  {
    return symbol_type (token::DOUBLEQUOTE, v);
  }
...
#line 1051 "binary.tab.hh" // lalr1.cc:377
